...
<body>
	...
	<div class="navbar">
		<a class="appbrand" align="center" href="dtAll.jsp"><img src="./pic/hhhy.png" width="130" alt=""
			...
			<ul class="menu-lists">
				...
				<li id="more-sub-menu" class="menu-list menu-lat  active"><a href="dtAll.jsp"
					...
					<ul class="sub-menu-list" id="sub-menu-list">
						...
						<li class="sub-active"><a href="#"><i></i><span>和讯股吧</span> </a></li>
						<li><a href="./dingtieJRJ.jsp?sid=<%=number%>"><i></i><span>金融界股吧</span> </a></li>
					</ul>
				</li>
			</ul>
		</div>
