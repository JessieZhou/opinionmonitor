...
<body>
	...
	<div class="navbar">
		<a class="appbrand" align="center" href="keylist"><img src="" width="130" alt=""
			...
			<form action="historyadd" method="get" align="center"
				...
				<div class="row-fluid">
					<div class="search-filter-box">
						...
						<%} else{%>
						<div class="export-submit">
							<input class="btn-red" disabled="disabled" type="submit" name="historyset" value="设置" title="只能对历史时间进行一次设定，一旦设定不能修改，请慎重">
						</div>
						<%} %>
						<!-- </div> -->
					</div>
